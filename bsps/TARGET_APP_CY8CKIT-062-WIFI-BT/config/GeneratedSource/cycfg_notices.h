...
#error "Unexpected MPN; expected DEVICE:=CY8C6247BZI-D54. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
...
#if !defined(CY8C6247BZI_D54)
#error "Unexpected MPN; expected DEVICE:=CY8C6247BZI-D54, ADDITIONAL_DEVICES:=CYW4343WKUBG. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CY8C6247BZI_D54) */
